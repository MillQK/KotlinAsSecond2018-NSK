...
fun isNumberHappy(number: Int): Boolean {
    ...
    val firstSum = firstPart / 10 + firstPart % 10
    val secondSum = secondPart / 10 + secondPart % 10
...
fun circleInside(x1: Double, y1: Double, r1: Double,
    ...
    val distanceBetweenCenters = Math.sqrt(Math.pow(x1 - x2, 2.0) + Math.pow(y1 - y2, 2.0))
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean {
    ...
    return min <= minWall && middle <= maxWall
}
